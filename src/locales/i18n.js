...
const messages = {
    fa: {
      ...
      footer:{
        ...
        detail:'پس از سالها فعالیت در حوزه آموزش و علی الخصوص موسیقی بر آن شدیم تا با ایجاد سامانه ائی پویا امکان ارائه دوره های آموزشی به تمام نقاط کشور و حتی خارج را داشته باشیم. ',
      ...
      home:{
        ...
        section1_detail:'پس از سالها فعالیت در حوزه آموزش و علی الخصوص موسیقی بر آن شدیم تا با ایجاد سامانه ائی پویا امکان ارائه دوره های آموزشی به تمام نقاط کشور و حتی خارج را داشته باشیم. این سامانه کلیه فعالیت های درون سازمانی آموزشگاه ها را پوشش می‌دهد و قابل استفاده برای تمامی آموزشگاه داران عزیز است. سامانه کار و ساز با هدف جذب نیروهای توانمند و جویای کار در زمینه تدریس موسیقی و آموزش به علاقمندان این رشته راه اندازی شده است.',
    ...
    `
      ...
      lesson:{
        ...
        list_subtitle: 'در این قسمت لیست تمامی کلاس‌های آموزشگاه را مشاهده می کنید. با انتخاب هر کدام اطلاعات دوره‌ها برای شما نمایش داده می شود.',
