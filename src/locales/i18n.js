...
const messages = {
    fa: {
      ...
      footer:{
        ...
        detail:'پس از سالها فعالیت در حوزه آموزش و علی الخصوص موسیقی بر آن شدیم تا با ایجاد سامانه ائی پویا امکان ارائه کلاس های آموزشی به تمام نقاط کشور و حتی خارج را داشته باشیم. ',
        ...
        phone:'<h4 class="text-white text-center"  >09122883802 <br> 026-6503521</h4>'
      },    
      home:{
