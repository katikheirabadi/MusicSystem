      ...
      <v-form class="sign-up">
        ...
        <v-row style="width: 100%;">
          <v-col cols="12" sm="12" md="12" lg="6">
            <v-text-field block class="field" :label="$t('message.login_signup_name')" required ></v-text-field>
          </v-col>
          <v-col cols="12" sm="12" md="12" lg="6" style="">
            <v-text-field class="field" :label="$t('message.login_signup_lastname') " required ></v-text-field>
          </v-col>
        </v-row>
