    ...
    <section class="w-100 m-auto">
      ...
      <v-sheet class="d-none d-md-block">
        <v-row class="mt-5 text-center d-flex justify-center">
          <v-col class="d-flex justify-center brown-bg align-center" cols="2">
            <h5>نام کلاس</h5>
          </v-col>
        ...
        <v-row v-for="(bagproduct, i) in bagproducts" class="text-center d-flex justify-center "
          ...
          <v-col cols="2" class="br-brown-sm d-flex align-center justify-center">
          ...
          <v-col cols="1" class="br-brown-sm d-flex align-center justify-center">
            <h5>{{ bagproduct.TakhfifeCloop }} %</h5>
          </v-col>
      ...
      <v-row>
        ...
        <v-col class="ma-1 " cols="12" md="4">
          ...
          <v-sheet class="">
            ...
            <v-row class="factorrow">
              <v-col cols="8">
                <h5>قابل پرداخت از محل اعتبار آموزشی</h5>
              </v-col>
              <v-col cols="4">
                <h5> {{ CartDetail.SysShare }} ریال</h5>
              </v-col>
            </v-row>
            <v-row class="factorrow">
